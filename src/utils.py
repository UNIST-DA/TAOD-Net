...
# image crop function
def get_img_cropped(data_path, pid, landmarks, mode=0, bound=0.2):
    '''
...
def get_metrics(real_values, pred_values):
    ...
    return  [Accuracy, Precision, Recall, F1, sensitivity, specificity, bac, wF1]
